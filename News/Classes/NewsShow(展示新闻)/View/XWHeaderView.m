...
@interface XWHeaderView ()<UICollectionViewDataSource,UICollectionViewDelegate>
...
//    UICollectionViewCell *cell=[collectionView dequeueReusableCellWithReuseIdentifier:XWScrollName forIndexPath:indexPath];
