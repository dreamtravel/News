...
@interface XWDetailContentController ()<UIWebViewDelegate,XWDetailBottomDelegate,XWWriteReplyDelegate>
...
-(void)setupWebView
{
    ...
    webView.height=self.view.height-self.navBar.height-DetailBottomH;
